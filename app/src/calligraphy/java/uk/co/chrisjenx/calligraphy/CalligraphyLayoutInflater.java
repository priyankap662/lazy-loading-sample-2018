...
import au.com.optus.express.calligraphy.FontFactory;
...
class CalligraphyLayoutInflater extends LayoutInflater implements CalligraphyActivityFactory {
    ...
    protected CalligraphyLayoutInflater(Context context, int attributeId) {
        ...
        fontFactory = new FontFactory(attributeId);
    ...
    public void setFactory(Factory factory) {
        ...
        if (!(factory instanceof WrapperFactory)) {
            super.setFactory(new WrapperFactory(factory, this, fontFactory));
        } else {
...
//            LayoutInflaterCompat.setFactory(this, new WrapperFactory2(factory2, fontFactory));
            super.setFactory2(new WrapperFactory2(factory2, fontFactory));
        } else {
    ...
    private void setPrivateFactoryInternal() {
        ...
        if (setPrivateFactoryMethod != null) {
            ReflectionUtils.invokeMethod(this,
                    ...
                    new PrivateWrapperFactory2((Factory2) getContext(), this, fontFactory));
        }
        mSetPrivateFactory = true;
    }
    ...
    public View onActivityCreateView(View parent, View view, String name, Context context, AttributeSet attrs) {
        return fontFactory.onViewCreated(createCustomViewInternal(parent, view, name, context, attrs), context, attrs);
    }
    ...
    protected View onCreateView(View parent, String name, AttributeSet attrs) throws ClassNotFoundException {
        return fontFactory.onViewCreated(super.onCreateView(parent, name, attrs),
                getContext(), attrs);
    }
    ...
    protected View onCreateView(String name, AttributeSet attrs) throws ClassNotFoundException {
        ...
        return fontFactory.onViewCreated(view, view.getContext(), attrs);
    }
